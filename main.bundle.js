...
/***/ (function(module, exports, __webpack_require__) {
	...
	var deleteFoodFromMeals = function deleteFoodFromMeals(meal, id) {
	  $.ajax({
	    type: 'DELETE',
	...
	module.exports = { deleteFoodId: deleteFoodId };
...
/***/ (function(module, exports) {
	...
	var reGetMeal = function reGetMeal(mealId) {
	...
	var sortTable = function sortTable(f, n) {
	...
	var sortHeaders = function sortHeaders() {
	  var f_nm = 1;
	  var clickCount = 0;
	  ...
	  $("#cal").on('click', 'button.sort-cal', function () {
	    if (clickCount === 0 || clickCount === 1) {
	      f_nm *= -1;
	      var n = $(undefined).prevAll().length;
	      sortTable(f_nm, n);
	      clickCount++;
	...
	var reGetFoods = function reGetFoods(foods) {
	  $('tbody.meal-foods-body').empty();
	  $.each(foods, function (i, food) {
	    prependMealFood(food);
	  });
	};

	module.exports = { getMeals: getMeals, prependMealFood: prependMealFood, addFoodToMeal: addFoodToMeal, sortTable: sortTable };
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var createFood = function createFood(food, calories) {
	  $.ajax({
	    type: "POST",
	    url: api + '/foods',
	    data: { food: {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!../../node_modules/css-loader/index.js!../../node_modules/sass-loader/index.js!./buttons.scss", function() {
				var newContent = require("!!../../node_modules/css-loader/index.js!../../node_modules/sass-loader/index.js!./buttons.scss");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
